...
public interface DrugMapper extends BaseMapper<Drug> {
    @Insert("insert into drug(name, producer, specification, nick_name, formula, cas, location, url, stock, note) values(#{name}, #{producer}, #{specification}, #{nickName}, #{formula}, #{cas}, #{location}, #{url}, #{stock}, #{note})")
    void insertDrug(String name, String producer, String specification, String nickName, String formula, String cas, String location, String url, String stock, String note);
